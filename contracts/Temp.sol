...
// contract Flashswap3MultiPool is Ownable {
...
//         // uint256 balance0 = info.poolPath[i].token0Reserve +
//         //   (isToken0IsIntermediaryToken ? oldAmount : 0);
//         // uint256 balance1 = info.poolPath[i].token1Reserve -
//         //   (isToken0IsIntermediaryToken ? 0 : currentTokenAmountInCyclicPool);

//         checkK(
//           info.poolPath[i].token0Reserve + (isToken0IsIntermediaryToken ? oldAmount : 0),
...
//     uint256 amount0In = balance0 > reserve0 - amount0 ? balance0 - (reserve0 - amount0) : 0;
//     uint256 amount1In = balance1 > reserve1 - amount1 ? balance1 - (reserve1 - amount1) : 0;
