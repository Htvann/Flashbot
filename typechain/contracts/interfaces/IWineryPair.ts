...
export interface IWineryPairInterface extends utils.Interface {
  functions: {
    ...
    "setDevFee(uint32)": FunctionFragment;
...
export interface IWineryPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IWineryPairInterface;
